...
def build_markup (potrace_paths, colors, img_width, img_height, include_bounds = DEFAULTS['include_bounds']):
    ...
    bounds = f'<rect x="0" y="0" width="{img_width}" height="{img_height}" fill="transparent" class="kittl-util_ignore-outline"/>\n' if include_bounds else ''
